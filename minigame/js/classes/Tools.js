...
* Tools
* librairie d'outils
*  /!\ Chaque nouvelle fonction doit être précédé d'une doc comprenant au moins un exemple d'utilisation /!\
*
* le code peux être minimifié directement
*/
...
*		ex: 	var UID = Math.uid();
*/
Math.uid=function(){CHARS="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";for(var e=CHARS,c=Array(36),b=0,d,a=0;36>a;a++)8==a||13==a||18==a||23==a?c[a]="-":14==a?c[a]="4":(2>=b&&(b=33554432+16777216*Math.random()|0),d=b&15,b>>=4,c[a]=e[19==a?d&3|8:d]);return c.join("")};
/** Array.unset
*	supprime un élément d'un tableau sans laisser de trou
*		ex: 	var test=["banane","orange","pomme"]
*		test.unset("orange");
*			||=> ["banane","pomme"]
*/
...
*
*	Crypte une chaine de caractères en SHA1
...
*			4) var rand = Dice.roll10();		// Dé de 10
*			4) var rand = Dice.roll12();		// Dé de 12
